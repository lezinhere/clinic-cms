            ...
            <div className="max-w-md w-full bg-white rounded-3xl p-10 shadow-xl border border-gray-100">
                    ...
                    <form onSubmit={handleSendOTP} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                required
                            />
                            <p className="text-[10px] text-gray-400 mt-2 px-1 text-center italic">Use the phone number you provided during booking.</p>
                        </div>
                    ...
                    <form onSubmit={handleVerifyOTP} className="space-y-6">
                        ...
                        <div>
                            <input
                                ...
                                required
                            />
                            <p className="text-[10px] text-gray-400 mt-4 px-1 text-center font-medium">DEMO OTP: <span className="text-teal-600 font-bold">123456</span></p>
                        </div>
                ...
                <div className="mt-8 pt-8 border-t border-gray-50 text-center flex flex-col gap-4">
                    <button
                        ...
                        className="text-teal-600 hover:text-teal-700 transition-colors text-sm font-semibold"
                    >
