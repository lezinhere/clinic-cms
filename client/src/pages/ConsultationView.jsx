        ...
        <div className="min-h-screen bg-slate-50/50 pb-20">
            ...
            <header className="bg-white border-b border-gray-200 sticky top-0 z-40 px-6 py-3 flex justify-between items-center shadow-sm">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-lg font-bold text-gray-900 leading-none">Clinical Workspace <span className="text-xs bg-emerald-100 text-emerald-800 px-2 py-1 rounded-full ml-2">v1.25-FinalPolish</span></h1>
            ...
            <main className="max-w-[1600px] mx-auto p-6 grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                {showSummary && (
                    <div id="printable-section" className="hidden print:block absolute inset-0 bg-white z-[10000] p-0 font-serif text-black h-full w-full overflow-visible top-0 left-0 m-0">
                        <style>
                            {`
                                @media print {
                                    @page { 
